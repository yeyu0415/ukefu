...
public abstract interface UserRepository extends JpaRepository<User, String>
{
  ...
  public abstract List<User> findAll(Specification<User> spec) ;
	...
	public abstract Page<User> findByDatastatusAndParentidOrId(boolean b, String parentid, String userid,
															   Pageable pageRequest);
	public abstract List<User> findByParentidAndDatastatus(String parentid,boolean b
													);
